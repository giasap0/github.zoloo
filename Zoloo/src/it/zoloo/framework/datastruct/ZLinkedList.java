 ...
 */
public class ZLinkedList<T> implements Serializable, Iterable<T>
{
	...
	protected class ZListNode implements Serializable
	{
		...
		public boolean equals(Object obj)
		{
			...
			if (obj == null)
				return false;
			if (!(obj instanceof ZLinkedList.ZListNode))
				return false;
		...
		private ZLinkedList<T> getOuterType()
		{
			return ZLinkedList.this;
		}
	...
	public ZLinkedList(ZLinkedList<T> other)
	{
		_head = _tail = null;
		_count = 0 ;
		if ( other.isEmpty() )
	...
	public ZListIterator<T> begin()				{ return new ZListIterator<T>(this,_head); }
	public ZListIterator<T> end()				{ return new ZListIterator<T>(this,_tail); }
	@Override
	...
	@SuppressWarnings("unchecked")
	@Override
	public ZLinkedList<T> clone() throws CloneNotSupportedException
	{
		try
		{
		...
		ObjectInputStream ois = new ObjectInputStream(byteIn);
			...
			return (ZLinkedList<T>) ois.readObject();
	 ...
	 */
	public void append( ZLinkedList<T> other)
	{
		if(_head == null)
		{
			this.copy(other);
	 ...
	 * @param other altra lista
	 */
	public void copy(ZLinkedList<T> other)
	{
		_head = _tail = null;
		for (T element : other)
		{
	...
	void insert(  ZListIterator<T> itr, T value)
	{
	 ...
	 */
	public void remove(ZListIterator<T> itr)
	{
	...
	public void replace(ZListIterator<T> itr, T newValue)
	{
